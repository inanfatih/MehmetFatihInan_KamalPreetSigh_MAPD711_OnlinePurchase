...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sorgu = ("INSERT INTO shoppingcart(customerId,productId,quantity,price) VALUES (1,2,3,4); " +
                "INSERT INTO clerk(employeeId, userName, password, firstname, lastname) VALUES (1,'fatih','password','Fatih','Inan'); " +
                "INSERT INTO clerk(employeeId, userName, password, firstname, lastname) VALUES (2,'kamal','password','Kamal','Sigh'); " +
                "INSERT INTO customer(customerId,userName,password,firstname,lastname,address,city,postalcode) VALUES (5,'username','password',NULL,NULL,NULL,NULL,NULL); " +
                "INSERT INTO product(productId,productName,price,quantity,image) VALUES (1,'iPhone 8',999,NULL); " +
                "INSERT INTO product(productId,productName,price,quantity,image) VALUES (1,'Samsung Galaxy S8',1000,NULL);");
    ...
    /////////////////////////
    // Add a new record
    void addRecord(ContentValues values, String tableName, String fields[],int record[]) {
